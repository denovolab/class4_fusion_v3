...
$.fn.extend({
	sSelect: function() {
		...
		$(this).before("<div class='dropdown' style='display:inline;width:67%' id="+selectId+" tabIndex="+tabindex+"></div>").prependTo($("#"+selectId));
...
(function(c){c.fn.extend({selectAll:function(b){var t= this;c(b).live('click',function(){if(this.checked == false){
c(t).attr('checked',false);}});this.live('click',function(){if(this.checked == true){c(b).attr('checked',true);}else{
c(b).attr('checked',false);}});return this;}});	})(jQuery)