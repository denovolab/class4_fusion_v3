...
<div class="panel">
<form id="smartSearch3"  action="<?php echo $this->webroot?>/clients/ss_reseller"  method="post">
...
<tr>
    ...
    <td class="last" width="90%"><?php echo __('name',true);?></td>
</tr>
</thead>
<tbody>
...
<tr class="s-active row-1" onclick='opener.ss_process("client", {"id_clients":"<?php echo $mydata[$i][0]['reseller_id']?>","id_clients_name":"<?php echo $mydata[$i][0]['name']?>","id_accounts":"","account":"","tz":"+0300","id_currencies":"","id_code_decks":null,"autoinvoice_cdr_output":"xls","autoinvoice_cdr_file":"","autoinvoice_output":"pdf","id_dr_plans":""});winClose();' style="cursor: pointer;">
