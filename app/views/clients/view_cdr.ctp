...
<ul id="title-search">
    ...
    $w=$action['writable'];?><!--
        <ul id="title-menu">
        <?php if(!empty($w)){ 	?>
<li><a href="<?php echo $this->webroot  ?>transactions/export_csv"><img width="16" height="16" alt="" src="<?php echo  $this ->webroot?>images/export.png"> 
导出
</a></li>
    ...
    <td align="center"><?php echo $mydata[$i][0]['create_time']?></td>
     ...
     ?></td>
       ...
       <td align="center"><?php echo $mydata[$i][0]['balance']?></td>
         <td align="center"><?php echo $mydata[$i][0]['cause']?></td>

      <td class="last">
<?php echo $mydata[$i][0]['description']?>
