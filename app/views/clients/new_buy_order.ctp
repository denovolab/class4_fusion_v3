<div id="title">
 <h1><?php  __('Management')?> &gt;&gt;<?php echo __('New Buy Order')?></h1>
 <ul id="title-search">
    ...
    <table class="list">
        <thead>
            ...
            <tr>
                ...
                <td>Rate</td>
                <td>Asr</td>
                <td class="last">Acd</td>
            </tr>
        </thead>
        <tbody>
            <?php foreach($data as $item): ?>
            <tr>
                <td><?php echo $item[0]['request_time']?></td>
                <td><?php echo $item[0]['name']?></td>
                <td><?php echo $item[0]['code_name']?></td>
                <td><?php echo sprintf("%.10f",$item[0]['rate'])?></td>
                <td><?php echo $item[0]['asr']?></td>
                <td class="last"><?php echo $item[0]['acd']?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
