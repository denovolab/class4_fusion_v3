<div id="title">
 <h1><?php  __('Management')?> &gt;&gt;<?php echo __('New Sell Order')?></h1>
 <ul id="title-search">
...
<div id="container">
    ...
    <table class="list">
        ...
        <tbody>
            ...
            <tr>
                <td><a href="<?php echo $this->webroot;?>/clients/new_sell_order_records?rate_table_id=<?php echo $item[0]['rate_table_id'];?>&flag=<?php echo $item[0]['flag'];?>&start_date=<?php echo urlencode($start_date);?>&end_date=<?php echo urlencode($end_date);?>" ><?php echo $item[0]['client_name']?></a></td>
                <td ><?php
                          if($item[0]['flag'] == 'U'){
                            echo "Update";
                          }else if($item[0]['flag'] == 'I'){
                            echo "Insert";
                          }else if($item[0]['flag'] == 'D'){
                            echo "Delete";
                          }else if($item[0]['flag'] == 'A'){
                            echo "Add";
                          }
