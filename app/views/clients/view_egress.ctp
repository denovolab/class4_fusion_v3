...
<div id="title">
   <h1><?php echo __('egress')?></h1>
    ...
    <ul id="title-menu">
      <?php if ($w == true) {?><!--
            <li><a href="<?php echo $this->webroot?>/rates/import_rate/59"><img width="16" height="16" src="<?php echo $this->webroot?>images/import.png">  <?php __('import')?></a></li>
       --><li><a class="link_btn" href="<?php echo $this->webroot?>/gatewaygroups/download_egress/"><img width="10" height="5" alt="" src="<?php echo $this->webroot?>images/export.png"><?php __('download')?></a></li>
        <li><a class="link_btn" href="<?php echo $this->webroot?>gatewaygroups/add_resouce_egress">
       <img width="16" height="16" alt="" src="<?php echo $this->webroot?>images/add.png"><?php echo __('addvoipgateway')?></a></li><?php }?>
        <li><a class="link_btn" rel="popup" href="javascript:void(0)" onclick="deleteSelected('container','<?php echo $this->webroot?>/gatewaygroups/del_selected?type=view_egress');">
        		<img width="16" height="16" alt="" src="<?php echo $this->webroot?>images/delete.png"> <?php echo __('deleteselected')?></a></li>
        		<li>
        		<!--javascript:void(0)  onclick="history.go(-1)"-->
    			<a class="link_back"href="history.go(-1)" >
...
<ul class="tabs">
 <li  ><a href="<?php echo $this->webroot ?>clients/edit/<?php echo $gate_client_id?>"><img width="16" height="16" src="<?php echo $this->webroot?>images/bDR.gif"/> <?php __('basicinfo')?></a></li>   
    ...
    <li   class="active"><a href="<?php echo $this->webroot?>clients/view_egress/<?php echo $gate_client_id?>"><img width="16" height="16" src="<?php echo $this->webroot?>images/menuIcon.gif"/> <?php __('egress')?></a></li> 
       <li  ><a href="<?php echo $this->webroot?>clients/view_ingress/<?php echo $gate_client_id?>"><img width="16" height="16" src="<?php echo $this->webroot?>images/bAccounts.gif"/> <?php __('ingress')?></a></li>
      </ul>
...
<tr>
    ...
    <td>
	    	<label><?php echo __('Trunk ID',true);?>
	    	<input type="hidden" id="query-id_clients" value="" name="query[id_clients]" class="input in-hidden"> :</label>
				<input  name="id" value="" id="id" type="text"  class="input in-text">   
			</td>
...
<?php //*********************表格头*************************************?>
		<div>	
			...
			<thead>
    			...
    			<td>			<a onclick="my_sort('resource.alais','asc')" href="javascript:void(0)"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-asc.png"></a>						
    					<?php echo __('alias',true);?>
    						<a onclick="my_sort('resource.alais','desc')" href="javascript:void(0)"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-desc.png"></a>
    					</td>
  <td >
  	<a onclick="my_sort('resource.name','asc')" href="javascript:void(0)"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-asc.png"></a>
    			<?php echo __('gatewayname')?>
    				<a onclick="my_sort('resource.name','desc')" href="javascript:void(0)"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-desc.png"></a>
    			</td>
    ...
    <td> 		<a onclick="my_sort('resource.cps_limit','asc')" href="javascript:void(0)"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-asc.png"></a>						
		...
		<img  title="<?php echo __('wangtoactive')?>" src="<?php echo $this->webroot?>images/flag-0.png"><?php }?>
		    ...
		    <td align="center"><?php  if(empty($mydata[$i][0]['client_id'])) {echo 0;}else{echo  1; }?></td>
               ...
               <td align="center">
                  		    ...
                  		    <?php if ($w == true) {?><a  style="float: left; margin-left: 40px;"  href="<?php echo $this->webroot?>gatewaygroups/edit_resouce_egress/<?php echo $mydata[$i][0]['resource_id']?>"  title="<?php echo __('edit')?>">
