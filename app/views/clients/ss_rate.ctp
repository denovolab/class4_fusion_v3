...
<tr class="s-active row-1" onclick='opener.ss_process("rate", {"id_rates":"<?php echo $mydata[$i][0]['rate_table_id']?>","id_rates_name":"<?php echo $mydata[$i][0]['table_name']?>"});closewindow();' style="cursor: pointer;">
