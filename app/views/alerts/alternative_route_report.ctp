...
<div id="title">
   <h1><?php __('Monitoring')?>&gt;&gt;<?php echo __('No Alternative Route Report')?></h1>  
		<ul id="title-search">
        	<!--<li>
...
$element_arr['No Alternative Trunk Route'] = Array('url'=>'alerts/alternative_route_report', 'active'=>true);
