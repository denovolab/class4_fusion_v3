<div id="title">
  <h1>
      <h1> <?php __('Configuration'); ?> &gt;&gt;<?php __('Default Failover Rule') ?></h1>
  </h1>
</div>
<div id="container">
<form  action="<?php echo $this->webroot?>systemparams/add_rule_post/"   id="hostForm"  method="post">
...
<tbody class="rows" id="rows-ip">
  ...
  <tr class="row-<?php echo  $i%2+1?>" id="row-<?php echo $i+1?>" style="">
    ...
    <?php  if ($_SESSION['role_menu']['Routing']['gatewaygroups:view']['model_w']) {?><td style="width: 200px;" class="value last">
    		<a href="#" id="tpl-delete-row"  value="<?php echo $host[$i][0]['reponse_code'] ?>" >
...
<script type="text/javascript" language="JavaScript">
	...
	$('.rows #tpl-delete-row').live('click', function () { fail
