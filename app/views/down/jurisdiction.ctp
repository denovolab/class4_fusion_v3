...
<div id="container">
    <ul class="tabs">
        <li><a href="<?php echo $this->webroot ?>jurisdictionprefixs/view"><img width="16" height="16" src="<?php echo $this->webroot ?>/images/menuIcon.gif">List</a></li>
        <li><a href="<?php echo $this->webroot ?>/uploads/jur_country"><img width="16" height="16" src="<?php echo $this->webroot ?>/images/import.png"> Import</a></li> 
        <li class="active"><a href="<?php echo $this->webroot ?>/down/jurisdiction"><img width="16" height="16" src="<?php echo $this->webroot ?>/images/export.png"> export</a></li>   
    </ul>
	<div id="down_panel">
