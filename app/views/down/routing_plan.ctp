...
<div id="container">
    <ul class="tabs">
        <li><a href="<?php echo $this->webroot ?>routestrategys/routes_list/<?php echo $id ?>"><img width="16" height="16" src="<?php echo $this->webroot ?>images/menuIcon.gif">List</a></li>
        <li><a href="<?php echo $this->webroot ?>uploads/route_plan/<?php echo $id ?>"><img width="16" height="16" src="<?php echo $this->webroot ?>images/import.png"> Import</a></li> 
        <li class="active"><a href="<?php echo $this->webroot ?>down/routing_plan/<?php echo $id ?>"><img width="16" height="16" src="<?php echo $this->webroot ?>images/export.png"> Export</a></li>   
    </ul>
	<div id="down_panel">
