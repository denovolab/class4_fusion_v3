...
<div id="container">
    <ul class="tabs">
    <li><a href="<?php echo $this->webroot ?>digits/translation_details/<?php echo $id; ?>"><img width="16" height="16" src="<?php echo $this->webroot ?>images/menuIcon.gif"> List</a></li>
    ...
    <li class="active"><a href="<?php echo $this->webroot ?>down/digit_mapping_down/<?php echo $id; ?>"><img width="16" height="16" src="<?php echo $this->webroot ?>images/export.png"> Export</a></li>
      </ul>
	<div id="down_panel">
