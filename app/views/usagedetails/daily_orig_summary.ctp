...
<div id="container">
	<ul class="tabs">
	  ...
	  <li><a href="<?php echo $this->webroot?>usagedetails/term_summary_reports"> <img width="16" height="16" src="<?php echo $this->webroot?>images/menuIcon.gif">Termination</a>  </li>
		 <li class='active'><a href="<?php echo $this->webroot?>usagedetails/daily_orig_summary"><img width="16" height="16" src="<?php echo $this->webroot?>images/list.png">Daily_Origination</a></li>
...
echo $this->webroot?>images/search_title_icon.png" />
  ...
  <?php echo $this->element('search_report/search_js');?><?php echo $form->create ('Cdr', array ('type'=>'get','url' => '/usagedetails/daily_orig_summary/' ,'onsubmit'=>"if ($('#query-output').val() == 'web') loading();"));?>  <?php echo $this->element('search_report/search_hide_input');?>
