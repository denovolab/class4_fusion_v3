...
<div id="container">
	<ul class="tabs">
	  ...
	  <li class='active'><a href="<?php echo $this->webroot?>usagedetails/term_summary_reports"> <img width="16" height="16" src="<?php echo $this->webroot?>images/menuIcon.gif">Termination</a>  </li>
...
<div class="table_container">
  <?php if(empty($data)): ?>
  <?php if($show_nodata): ?>
  <div class="msg">There were no data found for report</div><?php endif; ?>
  <?php else: ?>
...
echo $this->webroot?>images/search_title_icon.png" />
  ...
  <?php echo $this->element('search_report/search_js');?><?php echo $form->create ('Cdr', array ('type'=>'get','url' => '/usagedetails/term_summary_reports/' ,'onsubmit'=>"if ($('#query-output').val() == 'web') loading();"));?>  <?php echo $this->element('search_report/search_hide_input');?>
