...
<script type="text/javascript" src="<?php echo $this->webroot?>js/My97DatePicker/WdatePicker.js"></script>
	...
	<div id="title">
    <h1><?php echo __('editsalesstrategy')?></h1>
    <ul id="title-menu">
    		<li>
...
<div class="container">   
	...
	<?php echo $form->create ('Salestrateg', array ('action' => 'edit' ,'onsubmit'=>'return checkForm();'));?>
  <?php echo $form->input('sales_strategy_id',array('label'=>false,'div'=>false,'type'=>'hidden','value'=>$post['Salestrateg']['sales_strategy_id']))?>
 <input type="hidden" value="<?php echo $post['Salestrateg']['sales_strategy_id']?>" name="sales_strategy_id"/>
...
<tr>
    ...
    <td>
 		...
 		array('label'=>false ,'div'=>false,'type'=>'text','value'=>$post['Salestrateg']['name']));?>
    </td>
</tr>
...
<tr>
    ...
    <td>
 	...
 	'selected'=>$post['Salestrateg']['new_rate_table_id'],
...
<tr>
    ...
    <td>
 		...
 		array('options'=>$ratetable,'empty'=>__('selectratetable',true),'label'=>false ,
 	'selected'=>$post['Salestrateg']['expire_rate_table_id'],
 		'div'=>false,'type'=>'select'));?>
    </td>
</tr>
...
<tr>
    ...
    <td>
       		<?php 
       			...
       			empty($post['Salestrateg']['regular_customer'])?$sel='false':$sel='true';
...
<tr>
    ...
    <td>
       		<?php 
       	      	 		...
       	      	 		$pw=array("true"=>__('yes',true),"false"=>__('no',true));
       			empty($post['Salestrateg']['new_customer'])?$sel='false':$sel='true';
...
<!--  <tr>
    ...
    <td>
 		...
 		array('label'=>false ,'div'=>false,'type'=>'text','value'=> number_format($post['Salestrateg']['max_balance'], 3)));?>
    </td>
</tr>-->
...
<tr>
    ...
    <td>
   	...
   	$tmp=array('1'=>__('Each calculation',true),'2'=>__('Cumulative',true));
 		...
 		array('options'=>$tmp,'label'=>false ,'selected'=>$post['Salestrateg']['reward_type'],
...
<tr>
    ...
    <td>
 		...
 		array('label'=>false ,'div'=>false,'type'=>'text','maxlength'=>'3','value'=>$post['Salestrateg']['extended_days'],'style'=>'width: 210px;'));?><?php __('days')?>
    </td>
</tr>
...
<tr>
    ...
    <td>
    			<input id="SalestrategStartTime" class="Wdate" name="data[Salestrateg][start_time]" value="<?php echo $post['Salestrateg']['start_time']?>" readonly onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
    </td>
</tr>
...
<tr>
    ...
    <td>
    			<input id="SalestrategEndTime" class="Wdate" name="data[Salestrateg][end_time]" value="<?php echo $post['Salestrateg']['end_time']?>"  readonly onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
    </td>
</tr>
</table>
...
<table id="giftamounttab" cellspacing="0" cellpadding="0" width="100%" >
			<tbody><tr>
				...
				<td class="leftAlign rightBorder"><?php echo __('bonus_credit')?>(<?php __('a')?>)</td>
				<td class="leftAlign rightBorder"></td>
			</tr>

<?php 

if(empty($postcharges)){?>


					<tr>

						<td height="28px" class="leftAlign rightBorder">
						<input type="text" style="width:100px;" name="refill_amount[]" class="digit0 input in-text" size="20" id="refill_amount0" /></td>
						
						<td class="leftAlign rightBorder">
						<input type="text" style="width:100px;" class="match0 input in-text" name="basic_amount[]" size="15" id="basic_amount0"/></td>
						
						<td class="leftAlign rightBorder">
						<input type="text" style="width:100px;" class="match0 input in-text" name="gift_amount[]" size="15" id="gift_amount0"/></td>

						<td class="leftAlign rightBorder">
						
						<input type="text" style="width:100px;" name="bonus_credit[]" class="digit0 input in-text" size="20" id="bonus_credit0" /></td>
					...
					<?php }else{
						...
						<td height="28px" class="leftAlign rightBorder">
						<input style="width:100px;" type="text" name="refill_amount[]"  value="<?php echo $postcharges[$i][0]['refill_amount']?>"  class="digit0 input in-text" size="20" id="refill_amount0" /></td>
						
						<td class="leftAlign rightBorder">
						<input style="width:100px;" type="text" class="match0 input in-text" value="<?php echo $postcharges[$i][0]['basic_amount']?>" name="basic_amount[]" size="15" id="basic_amount0"/></td>
						
						<td class="leftAlign rightBorder">
						<input style="width:100px;" type="text" class="match0 input in-text"  value="<?php echo $postcharges[$i][0]['gift_amount']?>"  name="gift_amount[]" size="15" id="gift_amount0"/></td>

						<td class="leftAlign rightBorder">
						
						<input style="width:100px;" type="text" name="bonus_credit[]"  value="<?php echo $postcharges[$i][0]['bonus_credit']?>"  class="digit0 input in-text" size="20" id="bonus_credit0" /></td>
						  
						  

						<td align="left" width="60px" class="backGround leftAlign  topBorder">
						<a onclick="deletegift_amount(this);" href="javascript:;" class=" resource_add_Edit_style_24"><?php echo __('delete',true);?></a></td>
					</tr>
...
<table id="scoretab" cellspacing="0" cellpadding="0" width="100%"  style="width: 582px;">
			<tbody><tr>
				...
				<td height="25px" class="leftAlign1 rightBorder"><?php echo __('bonus')?>(<?php __('a')?>)</td>
				<td class="leftAlign rightBorder"><?php echo __('gift',true).__('gift_amount',true)?>(<?php __('money')?>)</td>
				<td class="leftAlign rightBorder"  style="width: 28px;"></td>
				
			</tr>

<?php if (empty($postpoints)) {?>
					<tr>

						<td height="28px" class="leftAlign rightBorder">
						<input style="width:100px;" type="text" name="bonus_credit_point[]" class="digit0 input in-text" size="20" id="bonus_credit_point0" /></td>
						
						<td class="leftAlign rightBorder">
						<input style="width:100px;" type="text" class="match0 input in-text" name="gift_amount_point[]" size="15" id="gift_amount_point0"/></td>
						...
						<td height="28px" class="leftAlign rightBorder">
						<input style="width:100px;" type="text" name="bonus_credit_point[]"  value="<?php echo $postpoints[$i][0]['bonus_credit']?>"  class="digit0 input in-text" size="20" id="bonus_credit_point0" /></td>
						
						<td class="leftAlign rightBorder">
						<input type="text" class="match0 input in-text"  value="<?php echo $postpoints[$i][0]['gift_amount']?>"  name="gift_amount_point[]" size="15" id="gift_amount_point0"/></td>
...
<input type="button" value="<?php echo __('reset')?>" onclick="$('input').val('');$('select').val('');"/>
    </div>
		<?php echo $form->end();?>
