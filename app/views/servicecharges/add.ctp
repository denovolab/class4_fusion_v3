	<div id="title">
    <h1><?php echo __('Add Service Charge',true);?></h1>
    <ul id="title-menu">
    		<li>
		...
		<?php echo $form->create('Servicecharge',array('action'=>'add'));?>
	<div class="container">
...
<tbody><tr>
    ...
    <td class="value value2"><?php echo $form->input('name',array('label'=>false,'div'=>false,'type'=>'text','maxLength'=>'16'))?></td>
</tr>
<tr>
...
jQuery(document).ready(function(){
  jQuery('#ServicechargeName').xkeyvalidate({type:'strNum'});
  jQuery('#ServicechargeBuyRate,#ServicechargeBuyMaxRate,#ServicechargeGreaterBuyMaxRateFee,#ServicechargeLessBuyRateFee,#ServicechargeGreaterBuyRateFee,#ServicechargeSellRate,#ServicechargeSellMaxRate,#ServicechargeGreaterSellMaxRateFee,#ServicechargeLessSellRateFee,#ServicechargeGreaterSellRateFee')
     .xkeyvalidate({type:'Money'});
} );
//-->
</script>