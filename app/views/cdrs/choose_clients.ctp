...
<thead>
<tr>
    <td width="40%"><a href="javascript:void(0)" onclick="my_sort('client_id','asc')"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-asc.png"></a>&nbsp;ID&nbsp;<a href="javascript:void(0)" onclick="my_sort('client_id','desc')"><img width="10" height="10" src="<?php echo $this->webroot?>images/list-sort-desc.png"></a></td>
...
<tbody class="rows"><?php 
		    ...
		    <td><?php echo $mydata[$i][0]['client_id']?></td>
