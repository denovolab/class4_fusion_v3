...
<tr>
    ...
    <td>
   		<?php echo $form->input('Dynamicroute.name',   
 		array('label'=>false ,'div'=>false,'value'=>$post['Dynamicroute']['name'], 'type'=>'text'));?>
    </td>
</tr>
<tr>
    ...
    <td>
   		...
   		echo $form->input('Dynamicroute.routing_rule',
 		array('options'=>$arr1,'empty'=>__('pleaseselectrouterule',true),'label'=>false ,'selected'=>$post['Dynamicroute']['routing_rule'],
  ...
  <tr>
    ...
    <td>
   		...
   		echo $form->input('Dynamicroute.time_profile_id',
 		array('options'=>$user,'label'=>false ,'selected'=>$post['Dynamicroute']['time_profile_id'],
...
<a onclick="newItem();return false;" href="#"><img width="10" height="10" src="<?php echo $this->webroot?>images/add-small.png"> <?php echo __('createnew',true);?></a>
