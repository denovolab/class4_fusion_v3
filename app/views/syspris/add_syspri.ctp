...
<div id="title">
  <h1><?php __('Configuration')?>&gt;&gt;<?php echo __('Add Module',true);?></h1>
  <ul id="title-menu">
...
<?php echo $form->create ('Syspri', array ('action' => 'add_syspri'.'/'.$module_id ));?>
  ...
  <table class="form">
    <tbody>
      ...
      <tr>
        ...
        <td class="value value2">
		<?php echo $form->input('flag', array('options'=>(array('t'=>'True','f'=>'False')),'name'=>'data[Syspri][flag]','label'=>false ,'div'=>false,'type'=>'select'));?>
		</td>
      </tr>
      <tr>
