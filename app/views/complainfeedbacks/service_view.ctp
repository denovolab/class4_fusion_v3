...
<?php }?>
      <td class="last">
<a title="<?php echo __('del')?>" onclick="return confirm('<?php echo __('confirmdel')?>');" href="<?php echo $this->webroot?>complainfeedbacks/del_feedback/<?php echo $mydata[$i][0]['feedback_id']?>/<?php echo $mydata[$i][0]['complain_id']?>/<?php echo $mydata[$i][0]['status']?>"><img width="16" height="16" src="<?php echo $this->webroot?>images/delete.png"></a> 
      </td>
</tr>
