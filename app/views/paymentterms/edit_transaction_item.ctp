...
<div id="container">
    ...
    <table class="list1">
            <tr>
                <td >
                    Use Fee:<input value="<?php if(!empty($transaction_fee_items)){echo $transaction_fee_items[0][0]['use_fee'];}?>" id="use_fee" type="text" name="use_fee" style="width:220px;"></td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    <a href="<?php echo $this->webroot;?>paymentterms/edit_transaction_item/<?php echo $id;?>"><input type="button" value="reset" class="in-submit"></a>
                </td>
            </tr>
    </table>
    </form>
