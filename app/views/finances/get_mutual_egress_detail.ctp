<div id="title">
  <h1>
    <?php __('Finance')?>
    &gt;&gt;
    <?php __('Egress Mutual Balance')?>[<?php echo $client_name ?>]
  </h1>
     <ul id="title-menu">
         <li>
    ...
    <li>
        <a href="<?php echo $this->webroot; ?>finances/get_mutual_egress_detail/<?php echo $this->params['pass'][0] ?>?export=1" title="Export" class="link_btn">
