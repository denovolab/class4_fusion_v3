<div id="title">
  <h1>
    <?php __('Finance')?>
    &gt;&gt;
    <?php __('Overall Mutual Balance')?>[<?php echo $client_name ?>]
  </h1>
     <ul id="title-menu">
    ...
    <li>
        ...
        <?php endif; ?>
    <li>
        <a href="<?php echo $this->webroot; ?>finances/get_mutual_ingress_egress_detail/<?php echo $this->params['pass'][0] ?>?export=1" title="Export" class="link_btn">
...
<div id="container">
    <table class="list">
        <thead>
            <tr>
                <td colspan="5">Beginning Balance on <?php echo $start_time; ?> 00:00:00 is <?php echo $begin_balance; ?></td>
                <td colspan="7">Ending Balance on <?php echo $end_time; ?> 23:59:59 is <?php echo $end_balance; ?></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="4">Ingress</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $financehistory['FinanceHistory']['mutual_balance'];  ?></td>
                <td>
                    <?php if($_SESSION['role_menu']['Payment_Invoice']['reset_balance'] == 1): ?>
                    <a control="<?php echo isset($financehistory['FinanceHistory']['id']) ? $financehistory['FinanceHistory']['id'] : 0;  ?>" href="###" class="synchronize" title="Synchronize with Actual Balance">
                        <img src="<?php echo $this->webroot ?>images/synchronize.png">
                    </a>
                    <?php endif; ?>
                </td>
            </tr>
    ...
    $(function() {
        ...
        $synchronize.click(function() {
            ...
            $dd.dialog({  
                ...
                cache: false,  
                resizable: true,
                href: '<?php echo $this->webroot?>finances/synchronize/<?php echo $client_id; ?>/' + control,  
                modal: true,                
                buttons:[{
                        text:'Save',
                        handler:function(){
            ...
            $dd.dialog('refresh', '<?php echo $this->webroot?>finances/synchronize/<?php echo $client_id; ?>/' + control);  
        });
