<div id="title">
  <h1>
    <?php __('Finance')?>
    &gt;&gt;
    <?php __('Ingress Actual Balance')?>[<?php echo $client_name ?>]
  </h1>
     <ul id="title-menu">
         <li>
    ...
    <li>
        <a href="<?php echo $this->webroot; ?>finances/get_actual_ingress_detail/<?php echo $this->params['pass'][0] ?>?export=1" title="Export" class="link_btn">
...
<div id="container">
    <table class="list">
        <thead>
            <tr>
                <td colspan="4">Beginning Balance on <?php echo $start_time; ?> 00:00:00 is <?php echo $begin_balance; ?></td>
