...
<div id="title">
  <h1>
   <?php  __('Finance')?>
    &gt;&gt;
    <?php __('Invoice Notification Log')?>
  </h1>
  <ul id="title-search">
    <li>
      <?php //********************模糊搜索**************************?>
...
?>
  ...
  <table class="list">
      <thead>
        <tr>
          <td><?php echo $appCommon->show_order('invoice_time', __('Date Time',true));?></td>
          <td><?php echo $appCommon->show_order('name', __('Carrier',true));?></td>
          <td><?php echo $appCommon->show_order('total_amount', __('Amount',true));?></td>
      ...
      for ($i=0;$i<$loop;$i++){
        ...
        <tr>
          ...
          <td>
              <a href="<?php echo $this->webroot?>finances/view_invoice_email/<?php echo $mydata[$i][0]['invoice_number'];?>" title="view email">
                    <img src="<?php echo $this->webroot;?>images/bOrigTariffs.gif" />
              </a>
              <a href="<?php echo $this->webroot?>finances/createpdf_invoice/<?php echo $mydata[$i][0]['invoice_number'];?>" title="download">
                    <img src="<?php echo $this->webroot;?>images/download.png" />
              </a>
              <a href="<?php echo $this->webroot?>finances/invoice_notification_log/<?php echo $mydata[$i][0]['invoice_id'];?>" title="send mail">
