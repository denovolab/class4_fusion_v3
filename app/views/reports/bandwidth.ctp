<div id="title">
    <h1><?php __('Statistics')?>&gt;&gt;<?php  __('Bandwidth Report')?></h1>
</div>
...
<div id="container">
    ...
    <?php endif; ?>
<?php echo $form->create ('Cdr', array ('type'=>'get','url' => "/reports/bandwidth" ,'onsubmit'=>"if($('select[name=show_type]').val() == 0) loading();"));?>
