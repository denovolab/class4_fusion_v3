<div id="title">
    <h1><?php __('Statistics')?>&gt;&gt;<?php  __('Orig-TermReport')?></h1>
</div>
...
<div id="container">
    ...
    <?php endif; ?>
<?php echo $form->create ('Cdr', array ('type'=>'get','url' => "/reports/inout_report" ,'onsubmit'=>"if($('select[name=show_type]').val() == 0) loading();"));?>
