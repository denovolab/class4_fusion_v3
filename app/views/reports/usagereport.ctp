<div id="title">
    <h1><?php __('Statistics')?>&gt;&gt;<?php  __('UsageReport')?></h1>
</div>

<div id="container">
<ul class="tabs">
    <li <?php if($type == 1) echo 'class="active"'; ?>>
        <a href="<?php echo $this->webroot; ?>reports/usagereport/1">
            <img height="16" width="16" src="<?php echo $this->webroot; ?>images/list.png" />
            Origination
        </a>
    </li>
    <li <?php if($type == 2) echo 'class="active"'; ?>>
        <a href="<?php echo $this->webroot; ?>reports/usagereport/2">
