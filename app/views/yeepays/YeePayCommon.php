	...
	if($sNewString==$hmac) {
		if($r1_Code=="1"){
		     ...
		     // echo "<br>商户订单号:".$r6_Order."<br>";
		      echo "<script language=JavaScript type='text/javascript'>location='<?php echo $this->webroot?>/yeepays/refill/$p3_Amt';</script>";
		      ...
		      //echo "<br>支付卡密无效!";
		      echo "<script language=JavaScript type='text/javascript'>location='<?php echo $this->webroot?>/yeepays/refill_f/$p3_Amt/$pa8_cardNo/支付卡密无效'</script>";
		      return; 
		} else if($r1_Code=="7"){
//		      echo "<br>提交失败".$rq_ReturnMsg;
//		      echo "<br>支付卡密无效!";
...
//		      echo "<br>提交失败".$rq_ReturnMsg;
//		      echo "<br>订单号重复!";
echo "<script language=JavaScript type='text/javascript'>location='<?php echo $this->webroot?>/yeepays/refill_f/$p3_Amt/$pa8_cardNo/订单号重复'</script>";
		      return; 
		} else{
		      echo "<br>提交失败".$rq_ReturnMsg;
		      echo "<br>请检查后重新测试支付";
