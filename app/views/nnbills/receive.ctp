...
if(strtoupper($signMsg)==strtoupper($merchantSignMsg)){
	...
	switch($payResult){
		  ...
		  case "10":
			...
			*/
			...
			$rtnOk=1;
			$rtnUrl="http://localhost<?php echo $this->webroot?>/nnbills/show?msg=success!";
		  ...
		  default:
			...
			$rtnOk=1;
			$rtnUrl="http://localhost<?php echo $this->webroot?>/nnbills/show?msg=false!";
	...
	$rtnOk=1;
	$rtnUrl="http://localhost<?php echo $this->webroot?>/nnbills/show?msg=error!";
