...
<li  ><a href="<?php echo $this->webroot?>/monitorsreports/carrier/egress"><img width="16" height="16" src="<?php echo $this->webroot?>images/bNotes.gif"><?php echo __('egress')?></a>        </li>
</ul>
