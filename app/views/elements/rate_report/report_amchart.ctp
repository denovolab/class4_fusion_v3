...
<script type="text/javascript">
	 ...
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>ratereports/flash_setting.xml?f=cdr_count&report_type=<?php echo  $report_type ?>"));
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>/amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>/amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>ratereports/flash_setting.xml?f=duration&report_type=<?echo  $report_type ?>"));
...
<fieldset  style="display: block; border-top: 1px solid rgb(181, 199, 216);">
<legend style="color: rgb(125, 133, 142); font-size: 1.1em; font-weight: bold;">
<?php echo __('CDR Count  Percentage',true);?>
	</legend></fieldset>
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>/amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>/amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>ratereports/flash_setting.xml?f=cdr_count_percentage&report_type=<?echo  $report_type ?>"));
...
<fieldset  style="display: block; border-top: 1px solid rgb(181, 199, 216);">
<legend style="color: rgb(125, 133, 142); font-size: 1.1em; font-weight: bold;">
<?php echo __('Duration Percentage',true);?>
	</legend></fieldset>
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>/amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>/amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>ratereports/flash_setting.xml?f=duration_percentage&report_type=<?echo  $report_type ?>"));
