<div id="title">
  <h1><?php __('Configuration')?>&gt;&gt;<?php echo __('usermanager')?></h1>
	<?php echo $this->element('search')?>
	<ul id="title-menu">
    <?php  if ($_SESSION['role_menu']['Configuration']['users']['model_w']) {?>
		<li>
			<a class="link_btn" href="<?php echo $this->webroot?>users/add_last">
    	...
    	<li>
    		<a class="link_back" href="<?php echo $this->webroot?>users/last_login">
