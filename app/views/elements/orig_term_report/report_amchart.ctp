...
<?php echo __('Total Cost /Profit',true);?> 
	</legend></fieldset>
...
<script type="text/javascript">
	 ...
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>origtermstatis/flash_setting.xml?f=total_cost"));
...
<fieldset  style="display: block; border-top: 1px solid rgb(181, 199, 216);">
<legend style="color: rgb(125, 133, 142); font-size: 1.1em; font-weight: bold;">
<?php echo __('Time Total/Billed Orig/Term',true);?>    
	</legend></fieldset>
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>/amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>/amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>origtermstatis/flash_setting.xml?f=bill_time"));
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>/amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>/amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>origtermstatis/flash_setting.xml?f=asr_acd"));
...
<fieldset  style="display: block; border-top: 1px solid rgb(181, 199, 216);">
<legend style="color: rgb(125, 133, 142); font-size: 1.1em; font-weight: bold;">
<?php echo __('Call Count Orig/Term',true);?>
	</legend></fieldset>
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>/amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>/amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>origtermstatis/flash_setting.xml?f=call_count"));
