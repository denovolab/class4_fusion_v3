...
<ul class="tabs">
    ...
    <img src="<?php echo $this->webroot?>images/menuIcon.gif" height="16" width="16"/> <?php echo __('country',true);?></a></li>      
</ul>

<script type="text/javascript">var smartSearch = 2;</script>
<div class="panel">
<form id="smartSearch3"  action="<?php echo $this->webroot?>codedecks/ss_country_term"  method="get">
...
<tr class="s-active row-1"
 onclick='opener.ss_process("country_term", {"id_countrys":"<?php echo $mydata[$i][0]['country']?>"});winClose();' style="cursor: pointer;">
