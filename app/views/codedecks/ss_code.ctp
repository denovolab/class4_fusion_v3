...
<div id="title">
        <h1><?php echo __('code',true);?></h1>
</div>
<div class="container"  style="width: 591px;">
                
<ul class="tabs">
    <li class="active"><a href="">
    <img src="<?php echo $this->webroot?>images/menuIcon.gif" height="16" width="16"/> <?php echo __('code',true);?> </a></li>      
</ul>
...
<tr>
    <td width="20%"><?php __('code')?></td>
     <td width="20%"><?php echo __('code name')?></td>
...
<tr class="s-active row-1"
 onclick='opener.ss_process("code", {"code":"<?php echo $mydata[$i][0]['code']?>"});winClose();'
