...
<div class="panel">
<form id="smartSearch3"  action="<?php echo $this->webroot?>/codedecks/ss_country_all"  method="get">
...
<fieldset class="title-block" id="advsearch"  style="display:none;width: 100%;">
	<form method="get"  action="<?php echo $this->webroot?>/codedecks/ss_country_all/">
...
<tr>
    ...
    <td><label><?php echo __('code_name')?>:</label>
...
<tr>
    ...
    <td width="30%"><?php echo __('code_name')?></td>
...
<tr class="s-active row-1"
 onclick='var country=jQuery(this).find("td:nth-child(3)").html();country=jQuery.trim(country);opener.country_all_callback(country);winClose();' style="cursor: pointer;">
