...
echo $this->element('layout/header',array('h1'=>'Configuration','h1_span'=>' Edit Role <font class=\'editname\' title=\'Name\' >['.$role_name[0][0]['role_name'].']</font>  :','back_url'=>'sysrolepris/view_sysrolepri'));}else{
echo $this->element('layout/header',array('h1'=>'Configuration','h1_span'=>' Add Role ','back_url'=>'sysrolepris/view_sysrolepri'));
}?>


<div class="container">
    <?php echo $form->create ('Sysrolepri', array ('action' => 'add_sysrolepri' ,'name'=>'add_sysrolepri'));?>
    ...
    <div class="role_module">
        <ul>
            <li style="width:98%;">
                ...
                <table class="form">
                    <tr>
                        <td class="value"><div class="cb_select" style="height:32px; line-height:32px; border:0px;">	  <input id="SysrolepriRoleId" class="input in-text in-input" type="hidden" value="<?php echo array_keys_value($this->params,'pass.0')?>" name="data[Sysrole][role_id]">
                                ...
                                <div><?php echo __('Role Name',true);?>: <?php //echo $form->input('role_name',array('label'=>false,'div'=>false,'type'=>'text','maxLength'=>'100','class'=>'input in-text'))?>
                                    ...
                                    <input id="SysrolepriRoleName" class="input in-text in-input" type="text" value="<?php echo $role_name[0][0]['role_name']?>" maxlength="256" name="data[Sysrole][role_name]" style="width:180px;">
                            ...
                            <td colspan="2" class="value">
                                ...
                                <div class="cb_select input">
                                    ...
                                    <div style="clear:both;" class="alt"> 
                                        ...
                                        ?>
                                        <span style="float:left;">
                                            <input id="<?php echo $id_priname?>" type="checkbox" value="1" name="data[Sysrolepri][<?php echo $v1['pri_name']?>]" <?php if (!empty($sysrolepri[$v1['pri_name']])) echo 'checked="checked"'; ?>  onclick='module_check(this,"<?php echo $id_priname?>");' class="<?php echo $id_modulename;?>_all_syspri"/>
                                                   <label for="<?php echo $id_priname?>"><?php __($v1['pri_val']);?></label>
                                        </span>

                                        <span style="float:right;">
                                            <input type="checkbox" name="data[Sysrolepri][<?php echo $v1['pri_name']?>][model_r]" value="1" <?php if (!empty($sysrolepri[$v1['pri_name']]) && $sysrolepri[$v1['pri_name']]['model_r']==true){ ?> 
                                                   ...
                                                   <input type="checkbox" name="data[Sysrolepri][<?php echo $v1['pri_name']?>][model_w]" value="1" <?php if (!empty($sysrolepri[$v1['pri_name']]) && $sysrolepri[$v1['pri_name']]['model_w']==true){?> checked="checked" class="module_check  <?php echo $id_modulename.'_all_w'?>"<?php }else{?>class="module_check <?php echo $id_modulename.'_all_w'?>" 
                                                   <?php }?> id="<?php echo $id_priname?>_model_w"/>
                                                   <?php echo __('Write',true);?>&nbsp;
                                                   <input type="checkbox" name="data[Sysrolepri][<?php echo $v1['pri_name']?>][model_x]" value="1" <?php if (!empty($sysrolepri[$v1['pri_name']]) && $sysrolepri[$v1['pri_name']]['model_x']==true){?>checked="checked" class="module_check  <?php echo $id_modulename.'_all_x'?>" <?php }else{?>class="module_check <?php echo $id_modulename.'_all_x'?>" 
    ...
    <?php  if ($_SESSION['role_menu']['Configuration']['sysrolepris']['model_w']) {?>
