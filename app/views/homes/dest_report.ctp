        ...
        <script>
            $(function() {
                $('#test').treegrid({
                        ...
                        animate:true,
                        collapsible:true,
                        url:'<?php echo $this->webroot ?>reportss/get_dest_data?<?php echo $param;?>',
                        idField:'id',
                        ...
                        onBeforeLoad:function(row,param){
                                ...
                                if (row){
                                        var url = '';
                                        if(row.type && row.type == 'egress_trunk') {
                                            url = '<?php echo $this->webroot ?>reportss/get_dest_data3?egress_country='+row.egress_country+'&egress_code_name='+row.egress_code_name+'&egress_id='+row.egress_id+'&<?php echo $param;?>';
                                        } else if(row.type && row.type == 'code_name') {
                                            url = '<?php echo $this->webroot ?>reportss/get_dest_data2?egress_country='+row.egress_country+'&egress_code_name='+row.egress_code_name+'&<?php echo $param;?>';
                                        } else {
                                            url = '<?php echo $this->webroot ?>reportss/get_dest_data1?egress_country='+row.egress_country+'&<?php echo $param;?>';
                                        }
                                        $(this).treegrid('options').url = url;
                                } else {
                                        $(this).treegrid('options').url = '<?php echo $this->webroot ?>reportss/get_dest_data?<?php echo $param;?>';
                                        $('#loading').show();
                                }
                        }
                });
