...
<div id="title">
       <h1><?php echo __('configu')?>&gt;&gt;
        <?php echo __('addvoipgateway')?>        
       ...
       <ul id="title-menu">
      		...
      		<li><a class="link_back" href="<?php echo $this->webroot;?>gatewaygroups/view_egress"  ><img width="16" height="16" src="<?php echo $this->webroot ?>images/icon_back_white.png" alt=""> <?php echo __('goback')?> </a></li>
       </ul>
		...
		<table>
			...
			<tr>
				...
				<td><?php echo __('clients')?> :		
						<?php echo $form->input('client_id',array('options'=>$c,'empty'=>'==select==','label'=>false, 'class' =>'select' ,'div'=>false,'type'=>'select'));?>
				...
				<td ><?php echo __('gatewayname')?> :
								   		<?php echo $form->input('name',array('id'=>'name','label'=>false ,'div'=>false,'type'=>'text','maxlength'=>'15'));?>
		</td>
					<td><input type="radio"  checked="checked" value="true" name="gress" id="ingress1" onchange='check_gress()'>
		<input type="hidden" value="true"    id="_ingress"  name="_ingress"><?php echo __('ingress')?></td>
		
		<td><input type="radio" value="true" name="gress" id="egress1"  onchange='check_gress()'>
			<input type="hidden" value="false" name="_egress"   id="_egress"><?php echo __('egress')?></td>
			</tr>
		</tbody></table>
