...
<form action="<?php echo $this->webroot?>uploads/ingress_tran" method="POST" enctype="multipart/form-data">
...
<!--			<input type="radio" name="duplicate_type" value="overwrite" id="duplicate_type_overwrite">
        ...
        <tr><td align="right">Example:</td><td align="left"><a href="<?php echo $this->webroot?>example/resource_digit_mapping.csv" target="_blank" title="Show example file">show</a></td></tr>
	<tr>
