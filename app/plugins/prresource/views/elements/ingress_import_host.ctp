...
<form action="<?php echo $this->webroot?>uploads/ingress_host" method="POST" enctype="multipart/form-data">
...
<!--					<input type="radio" name="duplicate_type" value="overwrite" id="duplicate_type_overwrite">
					...
					<label for="duplicate_type_delete"><?php echo __('delete',true);?></label>
                        ...
                        <tr><td align="right">Example:</td><td align="left"><a href="<?php echo $this->webroot?>example/host.csv" target="_blank" title="Show example file">show</a></td></tr>
			<tr>
