...
class VendorsController extends DidAppController
{
	...
	$sql = "select * from resource where client_id = $client_id";
        ...
        $sql = "delete from rate_table where rate_table_id = {$resource[0][0]['rate_table_id']};delete from resource where resource_id = {$resource[0][0]['resource_id']};delete from resource_ip where resource_id = {$resource[0][0]['resource_id']};delete from resource_prefix where resource_id = {$resource[0][0]['resource_id']};";
        $this->Client->query($sql);
