...
<div id="title">
    <h1>Origination &gt;&gt; Vendors</h1>
    <ul id="title-menu">
       <li>
            <a href="<?php echo $this->webroot ?>did/vendors/add" title="Click here to create a new vendor" class="link_btn">
    ...
    <table class="list">
        ...
        <tbody id="resInfo<?php echo $i?>">
            <tr class="row-<?php echo $i%2 +1;?>">
                ...
                <td>
                    <a href="<?php echo $this->webroot ?>did/vendors/edit/<?php echo $this->data[$i]['Client']['client_id'] ?>" title="Edit"> 
                        <img src="<?php echo $this->webroot ?>images/editicon.gif"> 
                    </a>
                    
                    <a href="<?php echo  $this->webroot?>did/vendors/delete/<?php echo $this->data[$i]['Client']['client_id'] ?>" onclick="return confirm('Are you sure?');">
                    ...
                    <a target="_blank" href="<?php echo $this->webroot ?>did/did_reposs/index/<?php echo $this->data[$i]['Client']['ingress_id'] ?>" title="View DID"> 
