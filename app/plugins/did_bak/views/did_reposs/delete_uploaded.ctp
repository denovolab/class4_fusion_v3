...
<div id="title">
    <h1><?php echo __('Origination',true);?>&gt;&gt;<?php echo __('Vendor DID Repository',true);?>&gt;&gt;<?php __('Delete Uploaded'); ?></h1>
    <ul id="title-menu">
        <li>
        ...
        <tbody>
            ...
            <tr>
                <td align="right">
                    Example File
                <td align="left">
                    <a href="<?php echo $example ?>" target="_blank" title="click to download">Download</a>
                </td>
            </tr>
            <tr>
                <td colspan="2">
