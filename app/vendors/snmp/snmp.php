...
$settings = array(
		...
		'path_php_binary'=>'/opt/lampp/bin/php',
		'path_snmpwalk'=>'/usr/local/netsnmp/bin/snmpwalk',
		'path_snmpget'=>'/usr/local/netsnmp/bin/snmpget',
		'path_snmpbulkwalk'=>'/usr/local/netsnmp/bin/snmpbulkwalk',
		'path_snmpgetnext'=>'/usr/local/netsnmp/bin/snmpgetnext',
		'path_cactilog'=>'/tmp/cacti.log',
