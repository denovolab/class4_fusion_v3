...
class SysmodulesController extends AppController
{
    ...
    function add_sysmodule()
    {
        ...
        if (!empty($this->data ['Sysmodule']))
        {
            ...
            $this->Session->write('m', $this->Sysmodule->create_json(201, __('The Module [' . $this->data['Sysmodule']['module_name'] . '] is created successfully!', true)));
            if (empty($flag))
            {
    ...
    function _add_sysmodule_impl($params = array())
    {
        ...
        if ($this->RequestHandler->isPost())
        {
            $this->_create_or_update_sysmodule_data($this->params['form']);
             $this->Session->write('m', $this->Sysmodule->create_json(201, __('The Module [' . $this->data['Sysmodule']['module_name'] . '] is modified successfully!', true)));
        }
        #get
        else
        {
